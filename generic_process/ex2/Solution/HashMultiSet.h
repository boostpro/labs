...
public:
    ...
    //{
    //    #if 0 // linear search
    //    for (std::size_t n = 0; n < bcount; ++n)
    //    #else // O(1)
    //    std::size_t n = value % bcount;
    //    #endif 
    //    {
    //        List::Iterator pos = ::Find(buckets[n].Begin(), buckets[n].End(), value);
    //        if(pos != buckets[n].End())
    //            return Iterator(buckets + n, buckets + bcount - 1, pos);
    //    }
    //    return End();
    //}
};
