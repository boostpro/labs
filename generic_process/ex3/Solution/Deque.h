...
// The Segmented Iterator interface
inline True IsSegmented(DequeIterator)
{
    return True();
}

inline int* Local(DequeIterator& it)
{
    return it.first;
}

inline DequeSegment** Segment(DequeIterator& it)
{
    return it.sfirst;
}

inline int* Begin(DequeSegment* seg)
{
    return seg->first;
}

inline int* End(DequeSegment* seg)
{
    return seg->last;
}
